class BusinessesController < ApplicationController
  ...
  private
    ...
    def business_params
      params.require(:business).permit(:user_id, :neighborhood_id, :borough_id, :name, :street_address, :email, :website, :phone, :profile_photo, :map, :admin_email, :percent_to_client, :markdown_info, :consignment_period, :return_policy, :appointment_info, :special_offers, :ecommerce_site, :city, :state, :zip, :sunday_opening, :sunday_closing, :monday_opening, :monday_closing, :tuesday_opening, :tuesday_closing, :wednesday_opening, :wednesday_closing, :thursday_opening, :thursday_closing, :friday_opening, :friday_closing, :saturday_opening, :saturday_closing, :biztag_ids => [], :biztags_attributes => [:id, :name], :designer_ids => [], :designers_attributes => [:id, :name], :reviews_attributes => [:content, :rating, :user_id], :photos_attributes => [:business_photo_file_name, :business_photo_content_type, :business_photo_file_size, :business_photo_updated_at, :description, :user_id, :business_photo])
    end
